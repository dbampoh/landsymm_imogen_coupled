...
private:
	...
	// BLAZE FireMIP
	xtring file_mblaze_ba, file_mblaze_FLI, file_mblaze_mean_number_fires, file_mblaze_tree_mortality, file_mblaze_mean_fire_size, file_mblaze_weighted_ROS;
	...
	// BLAZE FireMIP
	Table out_mblaze_ba, out_mblaze_FLI, out_mblaze_mean_number_fires, out_mblaze_tree_mortality, out_mblaze_mean_fire_size, out_mblaze_weighted_ROS;
