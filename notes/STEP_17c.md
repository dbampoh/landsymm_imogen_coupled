...
#### 1.7.8 What's next (POST-block-8.0.1 status update at 2026-05-20 afternoon session 8.0.1 close — trunk_r13078 structurally imported into rebuild repo at `forks/trunk_r13078/`; baseline build verification PASS with NEW B48 `-lcurl` workaround documented; T_seq Installment-1 source-edit + .ins authoring at block 8.0.2 ACTIVE NEXT)
