...
#### 1.7.8 What's next (POST-B19 status update at 2026-05-18 evening B19 close-out)

Per the user-authorised next-task cluster (originally locked-in 2026-05-15 night at 17c.0.8 PREP close-out; updated at B19 close 2026-05-18 evening to reflect actual B19 outcomes):
...
2. **B20** ⏳ **NEXT-IN-QUEUE** at B19 close (~1-2 d). Literature-comparison sanity check for global N2O magnitudes per Tian 2020 GCB / Saikawa 2014 ACP / IPCC AR6 WG1 Ch. 5 / Saunois 2020 ESSD. Distinct from B19 Phase 4 (which compared against historical SSP1-2.6 atmospheric concentrations from Law Dome ice core); B20 compares against published natural-flux magnitude ranges (~6-10 TgN2O/yr soil-natural + ~1-2 TgN2O/yr fire-natural for LPJG-natural-only fraction). Phase 1 (assemble published references) → Phase 2 (run B19 closed-loop pipeline at full-resolution global gridlist) → Phase 3 (plot vs literature envelope) → Phase 4 (doc cascade + tag candidate `v0.20.0-b20-literature-sanity-checked` or variant).
