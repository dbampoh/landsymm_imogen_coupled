...
**Date:** 2026-05-22 (afternoon; session 9 day 3). **Commit hash:** _to be determined_ (this commit; on `main` working branch directly; no tag — doc-only architectural-clarification milestone not release-worthy).
