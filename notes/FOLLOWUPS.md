...
| B4 | ImogenInput Rh/W/Tmin/Tmax consumer wiring expansion | 1 d | **C2 era (step 17b); B12+B10+B6+B2+B3 ✅ done** | ⏳ **NEXT** (per re-ordered Option A sequence: B10→B6→B2→B3→**B4**→B1) |
