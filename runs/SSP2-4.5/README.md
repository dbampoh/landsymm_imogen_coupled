# `runs/SSP2-4.5/` — Coupled SSP2-4.5 scenario run setup
...
| `crop.ins`, `crop_n.ins`, `crop_n_*.ins` | LandSyMM-fork crop PFTs + stand list (copied verbatim from version_A's predecessor SSP1_RCP45 setup; only paths to LU/Nfert/irrig data updated to point at version_A's actual tree). |
...
- step-6 SSP245 NON_CO2 RF file added (was missing from our tree)
