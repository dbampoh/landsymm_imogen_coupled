...
public:
    ...
    /// Called by the framework at the end of each simulation day
    /** Similar to outannual but saves at end of growing season, not calendar year */
    virtual void outharvest(Gridcell& gridcell) = 0;
	
	/// Called by the framework at the end of each simulation day
    /** Same as outharvest, but only called if just_phu_pvd */
    virtual void outharvest_justphupvd(Gridcell& gridcell) = 0;

	/// Called by the framework at the end of each simulation calendar year
	// SSR: GGCMI
	virtual void outannual_ggcmi(Gridcell& gridcell) = 0;
    ...
    /// Called by the framework every day
    /** SSR: GGCMI: Creates output files for new stands */
    virtual void openlocalfiles_ggcmi() = 0;

    /// Called by the framework every day
    /** SSR: GGCMI: Closes stand level output files */
    virtual void closelocalfiles_ggcmi() = 0;
...
public:
    ...
    /// SSR GGCMI: Calls on all output modules
