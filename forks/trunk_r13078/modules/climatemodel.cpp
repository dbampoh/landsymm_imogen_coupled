...
//Some cleanups can be done later in terms of variable declaration, memory allocation and optimal variable usage
...
int RUN_IMOGEN_ENGINE() {
    ...
    std::string dirCommonOut = std::string((char*)IMOGENConfig::DIR_COMMON_OUT); //For outut on parallel runs, usually  "./" in the ins
    std::string fileClim;
