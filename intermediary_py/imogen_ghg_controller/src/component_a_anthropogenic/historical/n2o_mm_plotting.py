...
ax.set_title('Global N2O Totals',**TK); ax.set_ylabel('N2O (Tg yr\u207b\u00b9)',**LK); ax.set_xlabel('Year',**LK); sax(ax,(0.15,1.10)); ax.legend(fontsize=7.5,loc='upper left',framealpha=0.9,edgecolor=SC,fancybox=False)
...
ax.set_title('Species Breakdown (2006 params, detailed AWMS)',**TK); ax.set_ylabel('N2O (Tg yr\u207b\u00b9)',**LK); ax.set_xlabel('Year',**LK); sax(ax,(0,0.80)); ax.legend(fontsize=7,loc='upper left',framealpha=0.9,edgecolor=SC,fancybox=False)
...
ax.plot(yr,edgar,color=CE,linewidth=1.8,linestyle='-.',label='EDGAR total',zorder=10)
ax.plot(yr,fao,color=CF,linewidth=2.5,linestyle=':',label='FAO total',zorder=12)
ax.set_title('Regional Breakdown (2006 params, detailed AWMS)',**TK); ax.set_ylabel('N2O (Tg yr\u207b\u00b9)',**LK); ax.set_xlabel('Year',**LK); sax(ax,(0,0.80)); ax.legend(fontsize=7,loc='upper left',framealpha=0.9,edgecolor=SC,fancybox=False)
