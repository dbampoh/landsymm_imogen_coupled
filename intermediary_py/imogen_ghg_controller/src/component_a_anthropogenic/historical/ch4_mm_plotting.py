...
fig.suptitle('CH4 Emissions - Manure Management',fontsize=13,fontweight='bold',color='#1a1a1a',y=0.99)
...
plt.tight_layout(rect=[0,0,1,0.96]); plt.savefig(FIG_DIR + 'ch4_mm_trends.png',dpi=300,bbox_inches='tight',facecolor=fig.get_facecolor()); plt.close(); print("Saved: ch4_mm_trends.png")
