...
ax.set_title('Global CH4 Totals',**TK); ax.set_ylabel('CH4 (Tg yr\u207b\u00b9)',**LK); ax.set_xlabel('Year',**LK); sax(ax,(5,18)); ax.legend(fontsize=8,loc='upper left',framealpha=0.9,edgecolor=SC,fancybox=False)
...
ax.set_title('Species Breakdown (IPCC 2019 Tier 1)',**TK); ax.set_ylabel('CH4 (Tg yr\u207b\u00b9)',**LK); ax.set_xlabel('Year',**LK); sax(ax,(0,18)); ax.legend(fontsize=7,loc='upper left',framealpha=0.9,edgecolor=SC,fancybox=False)
...
ax.plot(yr,edgar,color=CE,linewidth=1.8,linestyle='-.',label='EDGAR total',zorder=10)
ax.plot(yr,fao,color=CF,linewidth=2.5,linestyle=':',label='FAO total',zorder=12)
ax.set_title('Regional Breakdown',**TK); ax.set_ylabel('CH4 (Tg yr\u207b\u00b9)',**LK); ax.set_xlabel('Year',**LK); sax(ax,(0,18)); ax.legend(fontsize=7,loc='upper left',framealpha=0.9,edgecolor=SC,fancybox=False)
fig.text(0.5,0.003,f'2020: LandSyMM={our[-1]:.3f}Tg | FAO={fao[-1]:.3f}Tg | EDGAR={edgar[-1]:.3f}Tg | RCMIP-derived={rcmip_mm[-1]:.3f}Tg  |  RCMIP: CMIP6 hist+SSP2-4.5 (2016-19 interpolated); EDGAR 3.A.2 prop.',ha='center',fontsize=7,color='#555555',style='italic',bbox=dict(boxstyle='round,pad=0.4',facecolor='#f5f5f0',edgecolor='#cccccc',alpha=0.9))
