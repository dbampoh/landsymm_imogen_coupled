...
ax.fill_between(yr,_lo,_hi,alpha=0.18,color='#888888',label='Inter-method spread (LandSyMM/FAO, EDGAR/FAO, RCMIP/FAO)')
...
ax.plot(yr, our_tot/fao,  color=C_OUR, linewidth=2.0,                 label='LandSyMM estimate / FAO')
