...
fig.suptitle('N2O Emissions - Synthetic N Fertilizer Application',fontsize=13,fontweight='bold',color='#1a1a1a',y=0.99)
...
ax.set_title('Global N2O Totals',**TK); ax.set_ylabel('N2O (Tg yr\u207b\u00b9)',**LK); ax.set_xlabel('Year',**LK); sax(ax,(0.3,3.2)); ax.legend(fontsize=7.5,loc='upper left',framealpha=0.9,edgecolor=SC,fancybox=False)
...
ax.set_title('Direct vs Indirect Decomposition (2006 params)',**TK); ax.set_ylabel('N2O (Tg yr\u207b\u00b9)',**LK); ax.set_xlabel('Year',**LK); sax(ax,(0,3.0)); ax.legend(fontsize=7.5,loc='upper left',framealpha=0.9,edgecolor=SC,fancybox=False)
...
ax.set_title('Regional Breakdown -- 2019, aridity-split',**TK); ax.set_ylabel('N2O (Tg yr\u207b\u00b9)',**LK); ax.set_xlabel('Year',**LK); sax(ax,(0,3.0)); ax.legend(fontsize=7,loc='upper left',framealpha=0.9,edgecolor=SC,fancybox=False)
plt.tight_layout(rect=[0,0,1,0.96]); plt.savefig(FIG_DIR + 'n2o_synfert_trends.png',dpi=300,bbox_inches='tight',facecolor=fig.get_facecolor()); plt.close(); print("Saved: n2o_synfert_trends.png")
